...
namespace Acrelec.Mockingbird.Payment_ROI_IPP350
{
    [Export(typeof(IPayment))]
    public class Payment_ROI_IPP350 : IPaymentCard, ICommunicatorCallbacks
    {
        private const string PAYMENT_ID = "372001";

        private const string PAYMENT_LOG = "Payment_ROI_IPP350";

        private const string PAYMENT_NAME = "ROI_IPP350";

        private const string PAYMENT_APPLICATION_NAME = "PAY_ROI_IPP350.exe";

        private const string PAYMENT_APPLICATION_PROCESS_NAME = "PAY_ROI_IPP350";
        ...
        private const string VISA_RRP_DATA_VALUE = "DF6B10012E0001000013890000000032204000DF6B0701022030004000DF6B1201AC000531026826200100000BB900000BB9DF6B1501AC0008310268261200000301000005DD000003E9DF6B1201AC0005310268261201000005DD000009C5DF6B1201AC0005310268260001000007D1000005DD";
