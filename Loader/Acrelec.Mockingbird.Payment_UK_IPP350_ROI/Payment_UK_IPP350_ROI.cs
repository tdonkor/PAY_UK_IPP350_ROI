...
namespace Acrelec.Mockingbird.Payment_UK_IPP350_ROI
{
    [Export(typeof(IPayment))]
    public class Payment_UK_IPP350_ROI : IPaymentCard, ICommunicatorCallbacks
    {
        private const string PAYMENT_ID = "10";

        private const string PAYMENT_LOG = "Payment_UK_IPP350_ROI";

        private const string PAYMENT_NAME = "UK_IPP350_ROI";

        private const string PAYMENT_APPLICATION_NAME = "PAY_UK_IPP350_ROI.exe";

        private const string PAYMENT_APPLICATION_PROCESS_NAME = "PAY_UK_IPP350_ROI";
        ...
        public Payment_UK_IPP350_ROI(ILogger logger = null)
        {
            this.logger = logger;
